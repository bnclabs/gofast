...
func TestStart(t *testing.T) {
	...
	ref := []byte{
		217, 217, 247, 159, 88, 35, 217, 1, 12, 88, 30, 216, 37, 191, 24,
		39, 25, 16, 2, 24, 40, 82,
		6, 99, 108, 105, 101, 110, 116, 1, 0, 0, 0, 0, 0, 0, 2, 0, 0, 0,
		255,
	}
...
func TestStream(t *testing.T) {
	...
	ref := []byte{
		217, 217, 247, 199, 88, 35, 217, 1, 12, 88, 30, 216, 37, 191, 24, 39,
		25, 16, 2, 24, 40, 82,
		6, 99, 108, 105, 101, 110, 116, 1, 0, 0, 0, 0, 0, 0, 2, 0, 0, 0,
		255,
	}
...
func TestFramePkt(t *testing.T) {
	...
	ref := []byte{
		88, 35, 217, 1, 12, 88, 30, 216, 37, 191, 24, 39, 25, 16, 2, 24, 40, 82,
		6, 99, 108, 105, 101, 110, 116, 1, 0, 0, 0, 0, 0, 0, 2, 0, 0, 0,
		255,
	}
	stream := transc.getlocalstream(false, nil)
