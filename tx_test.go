...
func TestPost(t *testing.T) {
	...
	ref := []byte{
		217, 217, 247, 198, 88, 33, 217, 1, 12, 88, 28, 216, 37, 191,
		24, 39, 2, 24, 40, 82,
...
func TestRequest(t *testing.T) {
	...
	ref := []byte{
		217, 217, 247, 129, 88, 33, 217, 1, 12, 88, 28, 216, 37, 191,
		24, 39, 2, 24, 40, 82,
		6, 99, 108, 105, 101, 110, 116, 1, 0, 0, 0, 0, 0, 0, 2, 0, 0, 0,
		255,
	}
...
func TestStart(t *testing.T) {
	...
	ref := []byte{
		217, 217, 247, 159, 88, 33, 217, 1, 12, 88, 28, 216, 37, 191, 24,
		39, 2, 24, 40, 82,
		6, 99, 108, 105, 101, 110, 116, 1, 0, 0, 0, 0, 0, 0, 2, 0, 0, 0,
		255,
	}
...
func TestStream(t *testing.T) {
	...
	ref := []byte{
		217, 217, 247, 199, 88, 33, 217, 1, 12, 88, 28, 216, 37, 191, 24, 39,
		2, 24, 40, 82,
		6, 99, 108, 105, 101, 110, 116, 1, 0, 0, 0, 0, 0, 0, 2, 0, 0, 0,
		255,
	}
...
func TestFramePkt(t *testing.T) {
	...
	ref := []byte{
		88, 33, 217, 1, 12, 88, 28, 216, 37, 191, 24, 39, 2, 24, 40, 82,
		6, 99, 108, 105, 101, 110, 116, 1, 0, 0, 0, 0, 0, 0, 2, 0, 0, 0,
		255,
	}
	stream := transc.getlocalstream(false, nil)
