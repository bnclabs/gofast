...
func TestPost(t *testing.T) {
	...
	ref := []byte{
		...
		2, 24, 40, 80, 159, 102, 99, 108, 105, 101, 110, 116, 1, 26, 0,
		160, 0, 0, 96, 255, 255,
	}
...
func TestRequest(t *testing.T) {
	...
	ref := []byte{
		...
		39, 2, 24, 40, 80, 159, 102, 99, 108, 105, 101, 110, 116, 1, 26, 0,
		160, 0, 0, 96, 255, 255,
	}
	stream := transc.getstream(nil)
	out := make([]byte, 1024)
...
func TestResponse(t *testing.T) {
	...
	ref := []byte{
		...
		2, 24, 40, 80, 159, 102, 99, 108, 105, 101, 110, 116, 1, 26, 0, 160,
		0, 0, 96, 255, 255,
	}
	stream := transc.getstream(nil)
	out := make([]byte, 1024)
...
func TestStart(t *testing.T) {
	...
	ref := []byte{
		217, 217, 247, 159, 88, 31, 217, 1, 12, 88, 26, 216, 37, 191,
		24, 39, 2, 24, 40, 80, 159, 102, 99, 108, 105, 101, 110, 116,
		1, 26, 0, 160, 0, 0, 96, 255, 255,
	}
	stream := transc.getstream(nil)
	out := make([]byte, 1024)
	wai := NewWhoami(transc)
...
func TestFramePkt(t *testing.T) {
	...
	ref := []byte{
		88, 31, 217, 1, 12, 88, 26, 216, 37, 191, 24, 39, 2, 24, 40,
		80, 159, 102, 99, 108, 105, 101, 110, 116, 1, 26, 0, 160, 0,
		0, 96, 255, 255}
	stream := transc.getstream(nil)
	out := make([]byte, 1024)
	wai := NewWhoami(transc)
